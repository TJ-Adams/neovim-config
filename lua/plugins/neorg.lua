...
vim.api.nvim_create_autocmd("BufEnter", {
    ...
    callback = function()
        ...
        keymap("n", "<leader>njw", function()
            vim.api.nvim_command('edit ' .. "journal/" .. get_current_year() .. "/weeks/" .. "w" .. get_current_week() .. ".norg")
        end)
        -- keymap("n", "<leader>njm", "<cmd>edit journal/2024/month.norg<cr>")
        keymap("n", "<leader>njm", function()
            vim.api.nvim_command('edit ' .. "journal/" .. get_current_year() .. "/months/" .. "m" .. get_current_month() .. ".norg")
        end)
        -- keymap("n", "<leader>njq", "<cmd>edit journal/2024/quarter.norg<cr>")
        keymap("n", "<leader>njq", function()
            vim.api.nvim_command('edit ' .. "journal/" .. get_current_year() .. "/quarters/" .. "q" .. get_current_quarter() .. ".norg")
        end)
