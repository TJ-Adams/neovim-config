...
goto_preview.setup({
    post_open_hook = function ()
        ...
        keymap("n", "<C-l>", function () move_right_and_unset() end, opts)
        keymap("n", "<C-h>", function () move_left_and_unset() end, opts)
        keymap("n", "<C-j>", function () move_down_and_unset() end, opts)
        keymap("n", "<C-k>", function () move_up_and_unset() end, opts)
    end,
